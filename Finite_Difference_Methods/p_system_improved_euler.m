...
figure(1); surf(V((4*n/9):(5*n/9),1:100)) % show results from first few time steps
title('v: v- = 1, v+ = 3'); ylabel('space'); xlabel('time'); shading interp; view(90,-90); axis tight
figure(2); surf(U((4*n/9):(5*n/9),1:100))
...
figure(3); surf(V((4*n/9):(5*n/9),1:100)) % show results from first few time steps
title('v: v- = 3, v+ = 1'); ylabel('space'); xlabel('time'); shading interp; view(90,-90); axis tight
figure(4); surf(U((4*n/9):(5*n/9),1:100))
...
figure(5); surf(V((4*n/9):(5*n/9),1:100)) % show results from first few time steps
title('v: v- = 1, v+ = 1.1'); ylabel('space'); xlabel('time'); shading interp; view(90,-90); axis tight
figure(6); surf(U((4*n/9):(5*n/9),1:100))
...
figure(7); surf(V((4*n/9):(5*n/9),1:100)) % show results from first few time steps
title('v: tanh approx v- = 1, v+ = 3'); ylabel('space'); xlabel('time'); shading interp; view(90,-90); axis tight
figure(8); surf(U((4*n/9):(5*n/9),1:100))
